export default function LandingImageSvg() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 372.61">
      ...
      <g id="freepik--Coins--inject-111">
        <circle
          ...
          cy="228.03"
          r="54.16"
          transform="translate(-129.43 88.65) rotate(-45)"
          style={{ fill: '#93C96D' }}
        ></circle>
        <circle
          cx="108.63"
        ...
        <circle
          ...
          cy="228.03"
          r="45.48"
          transform="translate(-134.42 241.82) rotate(-80.32)"
          style={{ opacity: 0.2 }}
        ></circle>
        <circle
          cx="111.5"
          cy="229.83"
          r="43.66"
          transform="matrix(0.07, -1, 1, 0.07, -125.66, 269.79)"
          style={{ fill: '#93C96D' }}
        ></circle>
        <circle
          cx="111.5"
        ...
        <circle
          ...
          cy="160.54"
          r="37.8"
          transform="translate(-53.37 151.18) rotate(-49.8)"
          style={{ fill: '#93C96D' }}
        ></circle>
        <circle
          cx="195.33"
        ...
        <circle
          ...
          cy="160.54"
          r="31.74"
          transform="translate(-52.86 153.84) rotate(-50.42)"
          style={{ opacity: 0.2 }}
        ></circle>
        <circle
          cx="196.54"
          cy="162.57"
          r="30.47"
          transform="translate(-51.97 165.07) rotate(-52.61)"
          style={{ fill: '#93C96D' }}
        ></circle>
        <circle
          cx="196.54"
      ...
      <g id="freepik--credit-card--inject-111">
        ...
        ></rect>
        <path
          d="M347.55,295.59a18.67,18.67,0,0,0,0-37.34h-24.1a18.67,18.67,0,0,0,0,37.34Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#93C96D' }}
        ></path>
        <rect
      ...
      <g id="freepik--Character--inject-111">
        ...
        <path
          ...
          transform="translate(0 -54.95)"
          style={{ fill: '#93C96D', opacity: 0.31 }}
        ></path>
        <path
        ...
        ></path>
        <polygon
          points="338.21 343.67 332.34 348.93 321.15 337.29 327.03 332.03 338.21 343.67"
          style={{ fill: '#e4897b' }}
        ></polygon>
        <polygon
          points="318.08 354.62 310.67 354.62 309.71 337.45 317.12 337.45 318.08 354.62"
          style={{ fill: '#e4897b' }}
        ></polygon>
        <polygon
          points="321.16 337.29 326.92 343.29 332.8 338.03 327.04 332.03 321.16 337.29"
          style={{ fill: '#ce6f64' }}
        ></polygon>
        <polygon
          points="317.12 337.46 309.71 337.46 310.21 346.31 317.62 346.31 317.12 337.46"
          style={{ fill: '#ce6f64' }}
        ></polygon>
        <path
        ...
        ></path>
        <polygon
          points="225.04 177.49 230.46 180.65 235 179.94 233.38 173.88 225.04 177.49"
          style={{ fill: '#e4897b' }}
        ></polygon>
        <path
        ...
        ></path>
        <polygon
          points="303.56 104.4 300.56 107.59 302.03 110.67 304.42 110.78 306.46 107.84 303.56 104.4"
          style={{ fill: '#93C96D' }}
        ></polygon>
        <path
        ...
        ></path>
        <path
          d="M301.35,117.5c-3.79,1.29-6.82,11.34-2.4,14S308.55,115.05,301.35,117.5Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#263238' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M320.47,121c-.11,0,2.35-.61,3.66-5C324.13,116.07,323.7,122.54,320.47,121Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#263238' }}
        ></path>
        <path
          d="M300.84,111.36c-6.45,2-3.78,4.25-1.11,4.81l6.12-2.4C296.55,115,300.84,111.36,300.84,111.36Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#263238' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M305.48,129.81c-.15.58-.58,1-1,.9s-.57-.63-.42-1.21.58-1,1-.89S305.63,129.23,305.48,129.81Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#263238' }}
        ></path>
        <path
          d="M298.88,128.36c-.15.58-.58,1-1,.9s-.57-.62-.42-1.2.57-1,1-.9S299,127.78,298.88,128.36Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#263238' }}
        ></path>
        <path
          d="M300.9,129.11a22.57,22.57,0,0,1-4,4.35,3.42,3.42,0,0,0,2.66,1.13Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#de5753' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M325.34,215.38,318,214.09l3.79,8.55s6.73,0,6.43-3.52Z"
          transform="translate(0 -54.95)"
          style={{ fill: '#e4897b' }}
        ></path>
        <polygon
          points="312.45 163.43 315.92 170.34 321.75 167.68 317.96 159.14 312.45 163.43"
          style={{ fill: '#e4897b' }}
        ></polygon>
        <polygon
          points="333.43 333.7 322.36 344.13 318.79 340.3 331.46 328.76 333.43 333.7"
          style={{ fill: '#93C96D' }}
        ></polygon>
        <polygon
          points="333.43 333.7 322.36 344.13 318.79 340.3 331.46 328.76 333.43 333.7"
        ...
        ></polygon>
        <polygon
          points="321.15 344.17 306.48 344.17 305.67 339.02 321.86 339.82 321.15 344.17"
          style={{ fill: '#93C96D' }}
        ></polygon>
        <polygon
          points="321.15 344.17 306.48 344.17 305.67 339.02 321.86 339.82 321.15 344.17"
